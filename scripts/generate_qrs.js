...
async function generateInventory() {
  ...
  for (let i = 1; i <= 100; i++) {
    ...
    // Generate high-resolution PNG (300x300, Error Correction M, dark slate/black on white)
  ...
  const testHtmlSheet = generatePrintableHtml({
    ...
    badgeText: 'TEST QR — NOT FOR LIVE EVENT',
  ...
  for (let i = 1; i <= 1000; i++) {
    ...
    // We store data URI for HTML sheet generation
    const dataUri = await QRCode.toDataURL(qrId, {
      width: 180,
      margin: 1,
      errorCorrectionLevel: 'M',
  ...
  console.log('🎉 TOTAL GENERATED: 1,100 QR Codes (1,000 Production + 100 Test)!');
}
...
<head>
  ...
  <style>
    ...
    * {
    ...
    .qr-card {
      border: 1px dashed ${isTest ? '#fda4af' : '#cbd5e1'};
      border-radius: 8px;
...
<body>
  <div class="print-controls">
    ...
    <button class="print-btn" onclick="window.print()">🖨️ PRINT ALL SHEETS</button>
  </div>
  ...
  ${pages
    ...
    <div class="page-container">
      ...
      <div class="grid">
        ${page
          ...
          <div class="qr-card">
            ...
            <div class="qr-brand">${isTest ? 'TEST ONLY · NOT LIVE' : 'EVOXIS 26 · PHYSICAL PASS'}</div>
          </div>
        `
          )
          .join('')}
      ...
      <div class="page-footer">
        ...
        <span>Generated for EvoXis'26 Operations Portal</span>
