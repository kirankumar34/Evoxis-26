...
export const EVENTS: EventItem[] = [
...

  {
    ...
    title: 'Reel Rush',
    category: 'Non-Technical',
    tagline: 'Cinema Trivia, Lyric Translation & Reel Performance.',
    shortDescription: 'Identify iconic Tamil dialogues, decode English-translated song lyrics & sing, and perform an engaging short reel on the spot.',
    fullDescription: 'A high-energy 3-round cinematic showdown! Test your Tamil cinema and music IQ in Dialogue Decode and Tune Hunt, then unleash your creativity by creating and performing a short reel based on the given theme.',
    teamSize: {
      min: 1,
      max: 4,
      description: '1 - 4 Participants per Team',
    },
    rounds: [
      {
        roundNumber: 1,
        title: 'Dialogue Decode',
        description: 'Identify the Tamil movie from the given dialogue. (Fixed time | +2 per correct answer).',
        duration: 'Fixed Time',
      },
      {
        roundNumber: 2,
        title: 'Tune Hunt',
        description: 'Identify the Tamil song from English-translated lyrics & sing it! (+2 per correct song).',
        duration: 'Fixed Time',
      },
      {
        roundNumber: 3,
        title: 'Reel It Up',
        description: 'Create & perform a short reel based on the given theme. (Evaluated on Creativity • Performance • Relevance • Teamwork).',
        duration: '30 - 45 Mins',
      },
    ],
    rules: [
      'Team size: 1–4 participants.',
      'Round 1 (Dialogue Decode): Identify the Tamil movie from the given dialogue within the fixed time (+2 points per correct answer).',
      'Round 2 (Tune Hunt): Identify the Tamil song from English-translated lyrics and sing it (+2 points per correct song).',
      'Round 3 (Reel It Up): Create and perform a short reel based on the given theme.',
      'Evaluation criteria for Reel It Up: Creativity, Performance, Relevance, and Teamwork.',
      'Mobile phones and external assistance are strictly prohibited in Rounds 1 & 2.',
      'Content must be respectful, original, and strictly adhere to campus decorum.',
      'Coordinators reserve the right to modify rules/timings; judges’ decisions are final and binding.',
    ],
    judgingCriteria: [
      'Creativity',
      'Performance',
...

  {
    ...
    teamSize: {
      min: 3,
      max: 5,
      description: '3 - 5 Members per Team / Group',
    },
    rounds: [
      {
        roundNumber: 1,
