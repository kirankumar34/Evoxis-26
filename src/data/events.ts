...
export const EVENTS: EventItem[] = [
...

  {
    ...
    title: 'Reel Rush',
    category: 'Non-Technical',
    tagline: 'Cinema Trivia, Lyric Translation & On-Campus Reel Creation.',
    shortDescription: 'Identify iconic Tamil dialogues, decode English-translated song lyrics, and craft an impactful 30–60s on-campus symposium reel.',
    fullDescription: 'A high-energy 3-round cinematic showdown! Test your Tamil cinema and music IQ in Dialogue Detective and Translation Trap, then unleash your creativity by shooting and editing an original 30–60 second vertical reel on campus.',
    teamSize: {
      min: 1,
      max: 3,
      description: '1 - 3 Participants per Team',
    ...
    rounds: [
      {
        ...
        description: 'Identify the movie name from famous played or displayed Tamil cinema dialogues. (+2 Pts per correct identification | No phones).',
        duration: '15 Mins',
      },
      {
        roundNumber: 2,
        title: 'Translation Trap',
        description: 'Recognize iconic Tamil songs from English-translated lyrics. (+1 Pt for Song, +1 Bonus Pt for Movie | No phones).',
        duration: '15 Mins',
      },
      {
        roundNumber: 3,
        title: 'Reel Making (On-Campus)',
        description: 'Shoot and edit an original 30–60s vertical reel (9:16 MP4) capturing campus moments with creative cuts, transitions, and audio.',
        duration: '45 - 60 Mins',
      },
    ],
    rules: [
      ...
      'Round 3: All footage must be captured and edited on-campus during the event (no pre-recorded clips).',
      'Format specs: 30–60 seconds, MP4 format, 9:16 vertical orientation.',
      'Content must be respectful, original, and strictly adhere to campus decorum & copyright standards.',
    ...
    judgingCriteria: [
      ...
      'Transitions & Editing (20%)',
      'Use of Audio & Music (15%)',
      'Symposium Relevance & Impact (20%)',
    ],
    prizes: {
      Prize: '₹1500 Cash Prize + Certificate of Excellence',
      allParticipants: 'Certificate ',
